...
const Icons = {
  ...
  wallets: (a) => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="2" y="5" width="20" height="14" rx="2" stroke="currentColor" strokeWidth="1.8" fill={a?'currentColor':'none'} fillOpacity={a?0.1:0}/><path d="M2 10h20" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/><circle cx="17" cy="15" r="1.5" fill="currentColor"/></svg>),
...
const NAV_ITEMS = [
  ...
  { key: 'nav_wallets',         icon: 'wallets',      href: '/wallets' },
