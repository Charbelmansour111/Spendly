    ...
    <Layout>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 relative" style={{ zIndex: 1 }}>
        ...
        {goals.length === 0 && debts.length === 0 ? (
          <div className="bg-linear-to-br from-red-500 to-rose-700 rounded-2xl px-5 py-8 mb-5 relative overflow-hidden text-center">
          ...
          <div className="bg-linear-to-br from-red-500 to-rose-700 rounded-2xl px-5 py-5 mb-5 relative overflow-hidden">
            <div className="absolute inset-0 opacity-10 pointer-events-none">
              <div className="absolute -top-6 -right-6 w-28 h-28 rounded-full bg-white" />
              <div className="absolute -bottom-6 -left-6 w-20 h-20 rounded-full bg-white" />
            </div>
