    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        ...
        <div className="flex gap-3 items-center">
          {showInstall && (
            <button
              ...
              className="px-4 py-2 bg-green-500 text-white font-semibold rounded-xl hover:bg-green-600 transition flex items-center gap-2"
            >
              📲 Install App
            </button>
          )}
          <a href="/login" className="px-4 py-2 text-indigo-600 font-semibold hover:bg-indigo-50 rounded-xl transition">Login</a>
      ...
      <div className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          ...
          <a href="/login" className="px-8 py-4 bg-white text-indigo-600 font-bold rounded-2xl hover:bg-indigo-50 transition text-lg border border-indigo-200">Login</a>
          {showInstall && (
            <button
              onClick={handleInstall}
              className="px-8 py-4 bg-green-500 text-white font-bold rounded-2xl hover:bg-green-600 transition text-lg shadow-lg shadow-green-200"
            >
              📲 Install Spendly App
            </button>
          )}
      ...
      {showInstall && (
        <div className="max-w-4xl mx-auto px-6 mb-8">
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-6 text-white flex justify-between items-center">
            ...
            <button
              onClick={handleInstall}
              className="bg-white text-green-600 px-6 py-3 rounded-xl font-bold hover:bg-green-50 transition whitespace-nowrap ml-4"
            >
              Install Now
            </button>
          </div>
