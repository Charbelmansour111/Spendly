    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex flex-col justify-between w-5/12 bg-linear-to-br from-emerald-700 to-teal-800 p-12 text-white">
        ...
        <div className="space-y-7">
          <p className="text-emerald-100 text-sm font-medium uppercase tracking-widest">Everything you get, free</p>
          {[
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-emerald-600 text-white py-3 rounded-xl font-semibold hover:bg-emerald-700 active:scale-[0.98] transition shadow-lg shadow-emerald-200 dark:shadow-none disabled:opacity-60 disabled:cursor-not-allowed mt-2">
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 mt-6 text-sm">
            ...
            <a href="/login" className="text-emerald-600 font-semibold hover:underline">Sign in</a>
          </p>
        </div>
      </div>
    </div>
